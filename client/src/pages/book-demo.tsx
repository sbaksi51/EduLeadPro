...
import { Calendar, Clock, Users, MessageSquare, GraduationCap, Home, BarChart3, Brain, Star, ChevronDown } from "lucide-react";
...
export default function BookDemo() {
  ...
  // NavBar state and items (shared with landing)
  const navItems = [
      ...
      <motion.section style={{ backgroundImage }} className="relative min-h-[60vh] flex flex-col items-center justify-center pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          <Button
            variant="purple"
            size="lg"
            className="w-48 h-14 text-base font-semibold shadow-xl"
      ...
      <div ref={heroRef} className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
            <Card className="glass-card border border-[#222] bg-[#18122b]/80 text-white shadow-2xl">
              <CardHeader>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="space-y-8">
            <Card className="glass-card border border-[#62656e] bg-[#18122b]/80 text-white shadow-2xl">
              <CardHeader>
