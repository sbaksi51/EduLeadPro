...
import { Check, Star, Zap, Shield, ArrowLeft, GraduationCap, IndianRupee, Users, Brain, Target, BarChart3, MessageSquare, Calendar, ArrowRight, Home } from "lucide-react";
...
export default function Pricing() {
  ...
  const navItems = [
    ...
    { name: "FAQ", url: "/#faq-section", icon: Shield },
