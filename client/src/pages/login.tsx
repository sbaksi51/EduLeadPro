        ...
        <Card className="border-slate-200 dark:border-slate-700 shadow-xl backdrop-blur-sm bg-white/90 dark:bg-slate-900/90">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white shadow-lg transform hover:scale-[1.02] transition-all duration-200 group"
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="text-sm text-orange-600 hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300 transition-colors duration-200 font-medium"
              >
                {isLogin 
